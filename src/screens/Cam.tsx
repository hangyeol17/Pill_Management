...
import { StyleSheet, SafeAreaView, View, Text, Image, ActivityIndicator, Linking, PermissionsAndroid } from 'react-native'
...
export default function Cam() {
    ...
    async function savePhoto(data: string) {
        ...
        setImageSource(`${RNFS.PicturesDirectoryPath}/${filename}`)
        console.log(`Move Picture to ${RNFS.PicturesDirectoryPath}/${filename}`)
    }
